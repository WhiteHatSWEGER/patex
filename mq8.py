...
class MQ8():
    ...
    RO_CLEAN_AIR_FACTOR = 10  # Sensor resistance in clean air divided by RO, adjust if necessary
    CALIBRATION_SAMPLE_TIMES = 50
    CALIBRATION_SAMPLE_INTERVAL = 50  # in milliseconds
    READ_SAMPLE_INTERVAL = 50  # in milliseconds
    READ_SAMPLE_TIMES = 5
    HYDROGEN_CURVE = [2.3, 0.45, -0.38]  # Example curve, adjust based on actual data
    ...
    def __init__(self, Ro=10, channel=ADS.P2):
        ...
        print("Calibrating MQ-8 on ADS1115 at address 0x49...")
    ...
    def MQ_Percentage(self):
        ...
        val["HYDROGEN"] = self.MQ_GetGasPercentage(read / self.Ro, self.HYDROGEN_CURVE)
...
# Example of using the MQ8 class
sensor = MQ8()
